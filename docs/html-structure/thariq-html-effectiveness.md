...
**Data:** 8 de maio de 2026, 14:56
**Link original:** https://x.com/trq212/status/2052809885763747935
**Métricas:** 6.7M views · 11K likes · 2.5K reposts · 721 replies
...
Why use Claude Code to make HTML files instead of Claude.ai or Claude Design for example? One of the biggest reasons is all the context Claude Code can ingest.
...
To make this more concrete, I've made many different HTML files for different use cases. You can view all of them here: <https://thariqs.github.io/html-effectiveness/>
